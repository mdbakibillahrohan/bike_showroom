                    ...
                    <div class="col-md-12">
                        <div class="table-responsive m-b-40">
                            <table class="table table-striped table-data3 data-table1">
                                ...
                                <tbody>
                                    ...
                                    @foreach($recivecash as $row)
                                        <tr>
                                            ...
                                            <td class="recive">{{ $row->received}}</td>
                                            <td>{{ $row->user->name}}</td>
                                ...
                                <tr>
                                    <td colspan="5" style="font-size: 14px; font-weight: bold; text-align: right;" class="totalrecive"> </td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
...
@section('pagescript')
    ...
    <script>
        ...
        $(function(){
            ...
            tally('td.totalrecive','td.recive:eq(' , "Total Profit : ");
